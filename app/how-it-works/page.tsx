        ...
        <div className="wrap article">
          ...
          <article className="article-body">
            ...
            <div className="takeaways">
              ...
              <ul>
                ...
                <li>
                  <Check aria-hidden="true" />
                  <span>
                    <b>Your answers stay in your browser.</b> Your account identifies you; your
                    answers are not stored on our servers.
                  </span>
                </li>
                <li>
                  <Check aria-hidden="true" />
                ...
                <li>
                  <Check aria-hidden="true" />
                  <span>
                    <b>Free for 7 days.</b> The full profile is $29.99 once. Nothing is charged
                    to begin.
                  </span>
                </li>
              </ul>
            ...
            <div className="cta-inline">
              ...
              <p className="fine">
                Free for 7 days. Cancel before it ends and you are never charged.
              </p>
            </div>
            ...
            <section className="prose" id="privacy">
              ...
              <p>
                Your answers are stored in this browser, on this device. An account gets you back
                into your own profile — it is not a copy of your answers, and we do not keep one on
                our servers. Nothing is sent anywhere as you type.
              </p>
              <p>
            ...
            <section className="prose" id="cost">
              ...
              <ul>
                <li>
                  <b>Free for 7 days.</b> The whole method, all four parts, the full profile.
                </li>
                <li>
